        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-brand-black rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden shadow-2xl">
            <div className="grid lg:grid-cols-2 items-stretch">
              <div className="p-8 sm:p-12 lg:p-20 flex flex-col justify-center items-start text-left">
                ...
                <p className="text-gray-400 mb-10 sm:mb-12 max-w-md text-base sm:text-lg leading-relaxed lg:mx-0">Fill out the form and we'll get back to you within 24 hours with a free estimate.</p>
